...
@section('content')
    ...
    <div class="card border-0 mb-4 ">
        ...
        <form action="/dashboard/posts/{{$post->id}}" method="POST">
                ...
                <textarea name="content" class="form-control my-editor" rows="12" id="content">{{ $post->content }}</textarea>
                <small class="form-text text-danger">{{$errors->first('content')}}</small>
                </div>
                <div class="form-group">
                    <label for="tags">Tags</label>
                    <input type="text" name="tags" value="{{ $tags }}" class="form-control" id="tags" aria-describedby="tags">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input id="featured" class="form-control" type="text" name="featured" value="{{ $post->featured }}">
                      </div>
                      <div id="holder" style="margin-top:15px;max-height:100px;"><img src="{{ $post->featured }}" style="margin-top:15px;max-height:100px;"></div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="status" name="status">
                    <option disabled>--Status Post--</option>
